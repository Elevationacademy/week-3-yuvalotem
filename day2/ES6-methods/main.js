...
// ]
// const increase = function(person){
//     person.forEach(p => p.salary += p.goodPerformance?300:0)
// }
// increase(people)
...
// let newmessagesFromDad = messagesFromDad.map(m => m.toLocaleLowerCase())
...
//     console.log("Lets go watch a movie");
// }else{
//     console.log("Lets saty at home");
// }
...
//  ex 1
//   const newarr = arr.map(u => {return {email: u.email, companyName: u.company.name}})
//   console.log(newarr);
...
// ex 5
// console.log(arr.every(u => u.address.city === "South Christy"))

// ex 6
// const user = arr.find(u => u.address.suite === "Apt. 950")
